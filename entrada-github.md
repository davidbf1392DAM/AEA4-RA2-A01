[Inici](index.md) | [Càlcul de la lletra del DNI amb C#](entrada-algorisme.md)
# Creació, configuració i ús de GitHub

En aquesta entrada explico com he creat, configurat i fet servir **GitHub** fins al moment de redactar aquesta activitat. També explico com he utilitzat **GitHub Desktop** i **Obsidian** per crear les entrades en format **Markdown** i pujar-les al repositori i, finalment, com he convertit el repositori en un petit web amb **GitHub Pages**.
...
A més de documentar el programa dins d’una entrada, també he afegit el fitxer de codi font al repositori. El fitxer **calcul_dni.cs** es troba dins d’una carpeta específica per al codi font.
